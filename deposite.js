...
document.getElementById('btn-deposite')?.addEventListener('click',function(){
   ...
   const input = 'depositeInput';
//    find the new value 
   const newValue = InputValue(input);

//    find the old value of old
   const balance = 'depositeTotal';

   const oldBalance = CheckTotal(balance);
  const total =  oldBalance + newValue;
//   console.log(total,newValue,oldBalance);
//    set the value of balanceTotal
